...
elif [[ "$ebfile" =~ "/home/sabayonuser/projects/python-ebuilder/python_ebuilder/portage/" ]]; then
    echo "!!!python-ebuilder"
    local_ebfile=$(echo $ebfile|sed -e 's@/home/sabayonuser/projects/python-ebuilder/python_ebuilder/portage/@/r/a/p/usr/local/portage/@')  
else
    echo "!!! unknown layman"
    exit 1
fi
...
echo "###emerge $1"
echo "###emerge =$1"
echo "cp $ebfile $local_ebfile"
echo "ebuild $local_ebfile digest"
